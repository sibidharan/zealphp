      ...
      <div class="why-engine-grid">
        ...
        <div class="why-engine-col why-engine-col-harness">
          ...
          <ul class="why-engine-list">
            ...
            <li><strong>CGI worker bridge</strong> &mdash; <code>cgiMode('pool' | 'fcgi')</code> dispatches legacy <code>public/*.php</code> files with true global-scope isolation (<code>'pool'</code> is the default: a pre-spawned warm worker pool that keeps the interpreter in memory, ~1&ndash;3&thinsp;ms; <code>'fcgi'</code> forwards to an external FastCGI / php-fpm pool) (<a href="/legacy-apps">/legacy-apps</a>)</li>
