      ...
      <div class="why-engine-grid">
        ...
        <div class="why-engine-col why-engine-col-harness">
          ...
          <ul class="why-engine-list">
            ...
            <li><strong>Coroutine-safe superglobals &amp; lifecycle presets</strong> &mdash; <code>App::mode('coroutine-legacy')</code> runs legacy request-style PHP concurrently: <code>$_GET</code> / <code>$_POST</code> / <code>$_SESSION</code>, <code>$GLOBALS</code>, function statics, and <code>require_once</code> state all isolate per coroutine via ext-zealphp; <code>define()</code> isolation is available as a separate opt-in via <code>App::defineIsolation(true)</code>. One-call lifecycle presets: <code>App::mode('coroutine')</code> (modern default), <code>App::mode('legacy-cgi')</code>, <code>App::mode('mixed')</code>. (<a href="/coroutines#lifecycle-modes">/coroutines#lifecycle-modes</a>)</li>
          </ul>
        </div>
      </div>
