...
<p class="stream-note">Returning a <code>\Generator</code> from any handler triggers streaming — see the <a href="/responses#return-contract">universal return contract</a> for the full table of return shapes, and the <a href="/templates#file-execution-family">file-execution family</a> for how <code>App::renderStream()</code> composes with <code>render()</code> / <code>renderToString()</code> / <code>include()</code> / <code>fragment()</code>.</p>
...
<h2 class="stream-h2">Live streaming demos</h2>

<!-- Generator SSR -->
<div class="inject-case stream-case">
  <div class="inject-case-header"><span class="badge badge-get">GET</span><code>/stream/ssr — Generator yield</code></div>
  <div class="stream-case-body">
    <p class="stream-case-hint">Opens a streaming connection. Watch sections appear one by one (1s, then 2s):</p>
    <button class="btn btn-primary btn-sm" data-streaming-demo="ssr">▶ Run Generator SSR</button>
    <div id="ssr-out" class="stream-out">Click Run to start…</div>
  </div>
</div>
...
<div class="inject-case">
  ...
  <div class="stream-case-body">
    <p class="stream-case-hint">10 events, 1 second apart. EventSource reconnects automatically on drop.</p>
    ...
    <div class="sse-log stream-sse-out" id="sse-out">Click Connect to start…</div>
  </div>
</div>
...
<h2 class="stream-h2-section">Streaming from templates — <code>App::renderStream()</code></h2>
...
<div class="callout info stream-mt">
