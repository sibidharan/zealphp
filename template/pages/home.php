...
<section class="hero">
  <div class="container">
    ...
    <p class="home-hero-tagline">
      The Async PHP Runtime for AI Web Apps</p>
    ...
    <p class="home-hero-stamp">Alpha &middot; v0.4.13 &middot; built on <a href="https://openswoole.com/" target="_blank" rel="noopener">OpenSwoole</a></p>
    <div class="cta">
...
<section class="section home-section-darkbg">
  <div class="container">
    ...
    <div class="qs-panel active" data-panel="starter">
      <div class="qs-block">
        <div class="qs-line"><span class="qs-num">1</span><span class="qs-cmd"><span class="qs-prompt">$</span> composer create-project zealphp/project:^0.4.13 my-app</span><button class="qs-copy" data-copy="composer create-project zealphp/project:^0.4.13 my-app">copy</button></div>
