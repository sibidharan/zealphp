    ...
    <table class="cmp-table">
      ...
      <tbody>
        ...
        <tr>
          <td>Coroutine</td>
          <td class="muted">
            <code>RequestContext</code>, request/response objects, <code>$g-&gt;get</code> / <code>$g-&gt;post</code> / <code>$g-&gt;session</code> (classic superglobals are only populated in Legacy or Mixed modes)
          </td>
          <td>One request</td>
        </tr>
        <tr>
