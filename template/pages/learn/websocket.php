...
<div class="learn-layout">
  ...
  <article class="lesson-content">
    ...
    <p>
      ...
      connections per worker — coroutines mean each one costs ~5&nbsp;KB of memory and zero
...
$app-&gt;route('/api/counter/bump', ['methods' =&gt; ['POST']], function () use ($counter) {
    ...
    <?php App::render('/components/_concept_check', [
      ...
      'correct'  => 'b',
      'explain'  => 'SSE is one-way (server &rarr; client) over plain HTTP. EventSource auto-reconnects, works through every proxy, no upgrade handshake. WebSocket is the right tool when the client also needs to send — but for push-only, SSE is lighter.',
      'options'  => [
