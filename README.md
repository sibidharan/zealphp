...
```bash
# New project
composer create-project sibidharan/zealphp-project:^0.2.37 my-project
cd my-project
php app.php
...
3. Tag both `zealphp` and `zealphp-project` with the same version:
   ```bash
   git tag -a v0.2.37 -m "Release v0.2.37"
   git push origin master && git push origin v0.2.37
   ```
